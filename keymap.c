...
const key_override_t arrow_up_override      = ko_make_basic(MOD_MASK_CTRL, KC_I, KC_UP);
const key_override_t arrow_left_override    = ko_make_basic(MOD_MASK_CTRL, KC_J, KC_LEFT);
const key_override_t arrow_down_override    = ko_make_basic(MOD_MASK_CTRL, KC_K, KC_DOWN);
const key_override_t arrow_right_override   = ko_make_basic(MOD_MASK_CTRL, KC_L, KC_RIGHT);
const key_override_t delete_override        = ko_make_basic(MOD_MASK_CTRL, KC_BSPC, KC_DEL);
